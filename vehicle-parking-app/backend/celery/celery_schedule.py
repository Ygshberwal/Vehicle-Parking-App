...
def setup_periodic_tasks(sender, **kwargs):
    ...
    sender.add_periodic_task(
        ...
        email_reminder.s('yogesh@example', 'Test Daily Reminder', '<h1>This is your daily parking reminder</h1>'),
    ...
    sender.add_periodic_task(
        crontab(hour=17, minute=50, day_of_month='15'),
